...
m = readtable(sprintf('/scratch/st-tv01-1/hcp/reliability/rearranged_matrices/matlab_roi_%s.csv', roi));
...
csvwrite(sprintf('/scratch/st-tv01-1/hcp/reliability/dist_mats/roi_%s_dist.csv', roi), D)
